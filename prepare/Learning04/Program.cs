...
class Program
{
    ...
    {
        Assignment stu1 = new Assignment("Eze", "Making Billions to Trillions");
        ...
        WritingAssignment stu3 = new WritingAssignment("Eze Nwangele", "High Finance", "The merger of High Finance with High Tech");
